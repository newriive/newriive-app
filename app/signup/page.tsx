  ...
  return (
    <main className="bg-brand-white rounded-xl shadow-md p-8 mt-10 font-body">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        />
        {errors.givenName && (
          <p className="text-red-600 text-xs mt-1">{errors.givenName}</p>
        )}
        <input
          value={familyName}
        ...
        />
        {errors.familyName && (
          <p className="text-red-600 text-xs mt-1">{errors.familyName}</p>
        )}
        <input
          value={birthdate}
        ...
        {errors.locale && (
          <p className="text-red-600 text-xs mt-1">{errors.locale}</p>
        )}
        <button
          type="submit"
