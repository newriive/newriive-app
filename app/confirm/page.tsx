    ...
    <main className="bg-brand-white rounded-xl shadow-md p-8 mt-10 font-body max-w-md mx-auto">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <input
          ...
          placeholder="Email"
          className="w-full border border-brand-gray rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-brand-indigo"
        />
        <input
          value={code}
        ...
        <button
          type="submit"
          className="bg-brand-indigo hover:bg-brand-gold transition-colors text-white px-4 py-2 rounded-md shadow focus:outline-none focus:ring-2 focus:ring-brand-gold"
        >
          Confirm
        </button>
      </form>
